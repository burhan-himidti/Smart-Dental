...
class LabPatient(models.Model):
    ...
    customer = fields.Many2one('res.partner', string='Partner', required=True)
    patient_image = fields.Binary(string='Photo')
    patient_id = fields.Char(string='Customer ID', readonly=True)
    name = fields.Char(string='Customer ID', default=lambda self: _('New'))
